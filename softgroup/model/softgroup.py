...
from .blocks import MLP, ResidualBlock, UBlock, UBlock_Tiny
...
class SoftGroup(nn.Module):
    ...
    def __init__(self,
        ...
        self.unet = UBlock(block_channels, norm_fn, 2, block, 5, 12, indice_key_id=1)
        ...
        if not semantic_only:
            self.tiny_unet = UBlock_Tiny([channels, 2 * channels], norm_fn, 2, block, indice_key_id=11)
